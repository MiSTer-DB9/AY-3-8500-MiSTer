...
UPSTREAM_REPO="https://github.com/MiSTer-devel/AY-3-8500-MiSTer.git"
CORE_NAME=(AY-3-8500)
...
UPSTREAM_CORE_NAME=(AY-3-8500)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(AY-3-8500.qpf)
COMPILATION_OUTPUT=(output_files/AY-3-8500.rbf)
